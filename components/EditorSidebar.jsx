    ...
    <aside className="editor-sidebar" aria-label="Editor sidebar">
      ...
      <div style={{ marginTop:12 }}>
        ...
        <div style={{ marginTop:12 }}>
          ...
          <ConfirmModal open={confirmOpen} title='Confirmar acción' message='¿Desea continuar?' onCancel={()=> setConfirmOpen(false)} onConfirm={()=>{ if(confirmAction) confirmAction(); setConfirmOpen(false) }} />
    </aside>
  )
}
