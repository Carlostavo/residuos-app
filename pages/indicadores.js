    ...
    <div>
      ...
      <main className="container-max py-6">
        <section className="bg-white rounded-xl p-6 shadow">
          ...
          <p className="mt-2 text-slate-700">Panel con métricas principales.</p>
        </section>
      </main>
      ...
      <EditOverlay pageId="indicadores" open={(typeof window !== 'undefined' && localStorage.getItem('pae_edit_mode')==='true')} onClose={()=>{ localStorage.setItem('pae_edit_mode','false'); setEditable(false); }} />
    </div>
  );
}
