...
export default function Login(){
  ...
  return (
    <div className='app-shell'>
      <div className='max-w-md bg-white p-6 rounded shadow mx-auto mt-12'>
        ...
        <form onSubmit={signIn}>
          ...
          <input value={password} onChange={e=>setPassword(e.target.value)} type='password' className='w-full p-2 rounded border mb-3' />
