...
export default function IndicadoresPage() {
  ...
  const key = "contenido_indicadores"

  const [title, setTitle] = useState("Dashboard de Indicadores")
  const [desc, setDesc] = useState("Visualiza métricas y KPIs en tiempo real.")
