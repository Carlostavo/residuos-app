...
export default function AvancesPage() {
  ...
  const key = "contenido_avances"

  const [title, setTitle] = useState("Seguimiento de Avances")
  const [desc, setDesc] = useState("Revisa el progreso de tus proyectos y actividades.")
