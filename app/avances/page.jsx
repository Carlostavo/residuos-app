...
export default function AvancesPage() {
  ...
  const [pageTitle, setPageTitle] = useLocalStorage('avancesTitle', 'Progreso y Avances del Proyecto')
  const [pageDescription, setPageDescription] = useLocalStorage('avancesDescription', 'Visualiza el avance de tus iniciativas y proyectos.')
  
  const [cards, setCards] = useLocalStorage('avancesCards', [
    { 
      id: 1, 
