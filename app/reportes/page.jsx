...
export default function ReportesPage() {
  ...
  const [pageTitle, setPageTitle] = useLocalStorage('reportesTitle', 'Generación y Descarga de Reportes')
  const [pageDescription, setPageDescription] = useLocalStorage('reportesDescription', 'Crea informes personalizados para tus stakeholders.')
  
  const [cards, setCards] = useLocalStorage('reportesCards', [
    { 
      id: 1, 
