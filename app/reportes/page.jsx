...
export default function ReportesPage() {
  ...
  const key = "contenido_reportes"

  const [title, setTitle] = useState("Generación de Reportes")
  const [desc, setDesc] = useState("Crea, descarga y comparte reportes detallados.")
