...
drop policy if exists "admin full metas" on public.metas;
drop policy if exists "technician insert metas" on public.metas;
drop policy if exists "technician update own metas" on public.metas;
drop policy if exists "public read metas" on public.metas;
...
drop policy if exists "public read indicadores" on public.indicadores;
drop policy if exists "admin full indicadores" on public.indicadores;
...
drop policy if exists "public read avances" on public.avances;
drop policy if exists "admin full avances" on public.avances;
...
drop policy if exists "public read reportes" on public.reportes;
drop policy if exists "admin full reportes" on public.reportes;
...
-- storage note: create bucket 'images' and set public (or configure policies)
